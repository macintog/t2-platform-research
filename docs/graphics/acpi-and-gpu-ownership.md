# Host ACPI and graphics coordination
...
Public XNU [platform-action code at revision
`f6217f891ac0bb64f3d375211650a4c1ff8ca1ea`](https://github.com/apple-oss-distributions/xnu/blob/f6217f891ac0bb64f3d375211650a4c1ff8ca1ea/iokit/Kernel/IOPlatformActions.cpp)
...
a build-matched execution trace of RecoveryOS `25G83`. The pinned revision
records the comparator actually reviewed; it does not imply that RecoveryOS
was built from that revision.
