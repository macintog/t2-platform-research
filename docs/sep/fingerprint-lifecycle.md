...
authentication service. It must also provide the account-authority, client
ownership, recovery, and password-fallback boundaries described in the
[integration contracts](fingerprint-integration.md).
