...
FIRMWARE_UUIDS = {
    'docs/research/artifacts-and-method.md': '-'.join(
        ('D14EC38B', '9DE3', '32B0', '867C', '07C86AE9C97C')),
    'docs/research/create-v4-j214k.md': '-'.join(
...
def verify(root):
    ...
    try:
        ...
        for item in findings['findings']:
            ...
            check_link(root / 'findings.json', item['reference'])
        boards = json.loads((root / 'data/boards.json').read_text())
        ...
        doc = (root / 'docs/board-configurations.md').read_text()
